...
$("#priceForm").submit(function(e) {
  ...
  $.ajax({
    ...
    success: function(data) {
      ...
      // Wysłanie danych do modelu Machine Learning na Azure
      var azureFormData = {
        "data": {
          "offer_type": formData.offer_type,
          "area": formData.area,
          "rooms": formData.rooms,
          "offer_type_of_building": formData.offer_type_of_building,
      ...
      $.ajax({
        ...
        success: function(result) {
          // Aktualizacja wyniku prognozy od modelu
          $("#azurePrediction").text(result.Results.WebServiceOutput0[0].predicted_price);
        },
        error: function() {
          // Obsługa błędu
